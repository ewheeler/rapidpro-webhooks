...
class TestViews(TestCase):
    ...
    def test_validate_voucher(self):
        ...
        _json = {'run': u'5921746', 'phone': u'+12065551212', 'text': u'1', 'flow': u'701', 'weeks_since_last_menses': 0,
             ...
             'values': [{"category": {"eng": "All Responses"}, "time": "2014-10-29T17:45:02.071349Z", "text": "1", "rule_value": "1", "value": "1", "label": "Mother Name"},
                       {"category": {"eng": "All Responses"}, "time": "2014-10-29T17:45:02.071349Z", "text": v.code, "rule_value": "1", "value": v.code, "label": "voucher"},
                       {"category": {"base": "0 - 36", "eng": "0 - 40"}, "time": "2014-10-29T17:45:02.081099Z", "text": "1", "rule_value": "1", "value": "1.00000000", "label": "Weeks Since Last Menses"}],
